...
namespace Ka_veikia_seniunijos.Controllers
{
    ...
    public class EldershipController : Controller
    {
        ...
        public JsonResult GetAll()
        {
            ...
            MySqlCommand command = new MySqlCommand("Select * from BSJ0CVGChE.Eldership", connection);
        ...
        public int Post(Eldership Eldership)
        {
            ...
            string passwordHashed = Convert.ToBase64String(hashBytes);
            //
            string query = @"select * from BSJ0CVGChE.Eldership where name = '" + Eldership.Name + "'";

            string query2 = @"
                        insert into BSJ0CVGChE.Eldership (email, municipality, passwordHashed) values 
                        ('" + Eldership.Name + "','" + Eldership.Email + "','" + Eldership.Municipality + "','" + passwordHashed + "')";
